import * as NeuQuant from './NeuQuant';
import * as GIFEnCoder from './GIFEncoder';
import * as LZWEncoder from './LZWEncoder';
import {iGIFObj} from './iGifObj'
...
let utfGIFData : number[];
let img = new Image();
let imgData : ImageData;
let imgDataWOAlpha : number[] = [];
let imgDataURI = [];
let imgBlob: Blob;
...
const getRGB = function(data:number[]){
...
const convertData = function (data: string) {
...
const numberToUTFLilE = function (num: number) {
